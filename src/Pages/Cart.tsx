...
import { CartForm, CartProductCard, Delivery, Layout } from "../Components";
      ...
      <div className="container">
        ...
        {!productCart.length ? (
          <div className="cart-empty">
            ...
            <p className="cart-text">Выберайте товар и возвращайтесь!</p>
            <svg
            ...
            >
              <g>
                <path
                  d="M34.133,281.598c0,4.71,3.814,8.533,8.533,8.533h29.867c4.719,0,8.533-3.823,8.533-8.533s-3.814-8.533-8.533-8.533
				H42.667C37.948,273.065,34.133,276.888,34.133,281.598z"
                />
                <path
                  d="M153.6,426.665c-18.825,0-34.133,15.309-34.133,34.133c0,18.825,15.309,34.133,34.133,34.133
                ...
                />
                <path
                  d="M68.267,230.398c0-4.71-3.814-8.533-8.533-8.533h-51.2c-4.719,0-8.533,3.823-8.533,8.533c0,4.71,3.814,8.533,8.533,8.533
				h51.2C64.452,238.932,68.267,235.109,68.267,230.398z"
                />
                <path
                  d="M85.333,324.265H25.6c-4.719,0-8.533,3.823-8.533,8.533s3.814,8.533,8.533,8.533h59.733c4.719,0,8.533-3.823,8.533-8.533
				S90.052,324.265,85.333,324.265z"
                />
                <path
                  d="M409.6,426.665c-18.825,0-34.133,15.309-34.133,34.133c0,18.825,15.309,34.133,34.133,34.133
                ...
                />
                <path
                  d="M125.867,213.332c0,4.71,3.814,8.533,8.533,8.533h59.264l5.12,51.2h-53.717c-4.719,0-8.533,3.823-8.533,8.533
                ...
                />
                <path
                  d="M510.02,122.529c-1.621-1.937-4.019-3.063-6.554-3.063h-384c-4.719,0-8.533,3.823-8.533,8.533
                ...
                />
                <path
                  d="M435.2,392.532H196.267c-12.809,0-22.144,16.674-24.704,21.786c-2.108,4.207-0.393,9.327,3.814,11.435
          ...
          <>
            <div className="menuTitle">Корзина</div>
            <ul className="cartWrapper">
              {productCart.map((item, i) => (
                <CartProductCard {...item} key={i} />
              ))}
            </ul>
            <CartForm />
          </>
